        ...
        {isExpanded && (
          <div className="px-4 pb-5 pt-2 space-y-5" style={{ borderTop: '1px solid var(--border)' }}>
            <div className="grid grid-cols-2 gap-6">
              {/* Checklist */}
              <div>
                <p className="text-xs text-[var(--text-muted)] mb-3 uppercase tracking-wider">Checklist</p>
              ...
              {/* DSP Platforms */}
              <div>
                <p className="text-xs text-[var(--text-muted)] mb-3 uppercase tracking-wider">Distribution</p>
                <div className="space-y-2">
                  {DSP_PLATFORMS.map(dsp => (
                    <label key={dsp.key} className="flex items-center gap-2.5 cursor-pointer group">
                      <input
                        ...
                        className="accent-[#2dd4bf] w-3.5 h-3.5"
                      />
                      <span className={`text-sm transition-colors ${release[dsp.key] ? 'text-[var(--text-muted)] line-through' : 'text-[var(--text-secondary)] group-hover:text-[var(--text)]'}`}>
                        {dsp.label}
                      </span>
                    </label>
                  ))}
    ...
    <div className="max-w-4xl mx-auto px-6 py-8 pb-36 md:pb-10">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[var(--text-muted)] text-sm mt-0.5">Plan and track your upcoming releases</p>
        </div>
        <button
